            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5>Aqui você poderá realizar suas Movimentações Financeiras.</h5>
                ...
                <form action="realizar_movimento.php" method="post">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Digite o valor do movimento" name="valor" id="valor" value="<?= isset($valor) ? $valor : '' ?>" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Digite um Observação (Opcional)</label>
                            <textarea class="form-control" rows="4" placeholder="Digite um Observação aqui..." name="obs" id="obs"></textarea>
                        </div>
                        <button name="btn_confirmar" class="btn btn-success" onclick="return ValidarRealizarMovimento();">Realizar Movimento</button>
                    </div>
                </form>
